...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Devis, délais, garanties, matériaux : toutes les réponses de projet concept.",
    url: `${SITE_URL}/faq`,
    images: OG_IMAGES,
  },
};
    ...
    items: [
      {
        ...
        a: "Tous nos travaux bénéficient de la garantie biennale (2 ans) et décennale (10 ans) pour les ouvrages de gros œuvre.",
      },
      {
        q: "Êtes-vous assurés ?",
    ...
    <>
      ...
      >
        ...
        <div className="container">
          ...
          >
            Retrouvez les réponses aux questions les plus fréquentes. Vous ne
            trouvez pas ce que vous cherchez ? Contactez-nous directement.
          </p>
          <Link
            href="/contact"
            style={{
