...
const stats = [
  ...
  { val: "5 ans", label: "Garantie 10 ANS" },
];
  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Decorative vertical line — hidden on mobile via CSS */}
        <div
        ...
        <div className="hero-wrap" style={{ paddingBottom: 0 }}>
          ...
          >
            Depuis 2012, projet concept conçoit et réalise des espaces extérieurs
            d&apos;exception. Précision. Durabilité. Élégance.
          </p>
        ...
        <div className="marquee-track">
          {marqueeItems.map((item, i) => (
            ...
            >
              {item}
              {i % 2 === 0 && (
                <span style={{ marginLeft: "36px", color: "#C8A96E", opacity: 0.3 }}>◆</span>
              )}
            </span>
          ))}
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.78rem", color: "#8A8680", lineHeight: 1.5 }}>
                        {svc.desc}
                      </p>
                    </div>
                  </div>
          ...
          <div className="projects-grid">
            {projects.map((p, i) => (
              <div
                ...
                style={{ position: "relative", overflow: "hidden", background: "#111111", cursor: "pointer" }}
              >
                <div style={{ height: i === 0 ? "400px" : "300px", position: "relative", overflow: "hidden" }}>
                  <img
                    src={p.img}
                    alt={p.title}
                    style={{
          ...
          <div className="trust-grid">
            {[
              ...
              >
                ...
                <p style={{ fontSize: "0.82rem", color: "#5A5550", lineHeight: 1.7 }}>
                  {item.desc}
                </p>
              </div>
            ))}
              ...
              {process.map((step, i) => (
                <div
                  ...
                  style={{
                    ...
                    gap: "28px",
                    paddingBottom: "40px",
                    borderBottom: i < process.length - 1 ? "1px solid #141414" : "none",
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "0.88rem", color: "#5A5550", lineHeight: 1.7 }}>
                      {step.desc}
                    </p>
                  </div>
                </div>
      ...
      >
        ...
        >
          <p className="section-label" style={{ justifyContent: "center", marginBottom: "24px" }}>
            Prêt à commencer ?
          </p>
          <h2
            style={{
